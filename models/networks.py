...
class PoseResNet(nn.Module):
    def __init__(self, input_nc, weights=None, isTest=False, gpu_ids=[]):
        ...
        # Modify first layer if input_nc != 3
        if input_nc != 3:
        ...
        # Layer 2 output: 512 channels
        self.cls1_fc = RegressionHead(lossID="loss1", input_dim=512, weights=weights)
        # Layer 3 output: 1024 channels
        self.cls2_fc = RegressionHead(lossID="loss2", input_dim=1024, weights=weights)
        # Layer 4 output: 2048 channels
        self.cls3_fc = RegressionHead(lossID="loss3", input_dim=2048, weights=weights)
